...
<header data-v-9bc466b2="" class="page">
        <div data-v-9bc466b2="">
            ...
            <p data-v-9bc466b2="">It details the meticulous process through which each piece of art is created, resulting in a work of the highest quality.</p>
        </div>
    </header>
               ...
               <div class="swiper-video-container">
                  <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                              <video style="object-position: center" autoplay muted loop class="carousel-video" data-video="http://w2.local/wp-content/uploads/2024/12/charlie_chaplin.mp4">
...
<script> 
   document.addEventListener('DOMContentLoaded', () => {
    ...
    const images = Array.from(imagesContainer.children); // Obtiene todas las imágenes dentro del contenedor
    let order = [1, 2, 3]; // Inicializamos el order de las imágenes (el orden actual)

    // Función para cambiar el order de las imágenes
    function changeOrder() {
        // Desplaza el orden de las imágenes
        order.push(order.shift()); // El primer número del array se mueve al final

        // Asigna el nuevo 'order' a las imágenes
        images.forEach((img, index) => {
            img.style.order = order[index];
        });
    }

    // Cambiar el order cada 3 segundos
